    ...
    <main id="Imprint" className="card-screen">
      <Card header={<HeaderGoBack />} isLight={isLight}>
        ...
        <p>
          ...
          you wish to remove the data, that is associated with your account, you
          can do so by simply deleting your account from the account page. Once
          the Account delete has been issued you will be redirected to the
          homescreen and all saved reminders will be lost.
        </p>
      </Card>
    </main>
  );
